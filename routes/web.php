...
Route::middleware(['auth', 'active', 'permission:complaints.view'])->group(function () { Route::get('/complaints', [ComplaintWebController::class, 'index'])->name('complaints.index'); });
...
Route::middleware(['auth', 'active', 'permission:gis.view'])->group(function () { Route::get('/gis', [DashboardController::class, 'index'])->name('gis.index'); Route::get('/map', [GisController::class, 'index'])->name('map.index'); });
...
Route::middleware(['auth', 'active', 'permission:users.view'])->group(function () { Route::get('/users', [UserWebController::class, 'index'])->name('users.index'); });
...
Route::middleware(['auth', 'active', 'permission:users.view'])->group(function () { Route::get('/users/{user}', [UserWebController::class, 'show'])->name('users.show'); });
...
Route::middleware(['auth', 'active', 'permission:roles.view'])->group(function () { Route::get('/roles', [RoleWebController::class, 'index'])->name('roles.index'); });
...
Route::middleware(['auth', 'active', 'permission:permissions.view'])->group(function () { Route::get('/permissions', [PermissionWebController::class, 'index'])->name('permissions.index'); });
