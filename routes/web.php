...
Route::middleware(['auth', 'active', 'permission:gis.view|datasets.view'])->group(function () { Route::get('/gis', [DashboardController::class, 'index'])->name('gis.index'); Route::get('/map', [GisController::class, 'index'])->name('map.index'); });
