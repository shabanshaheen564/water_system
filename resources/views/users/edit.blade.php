    ...
    <div class="mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-ink-secondary">
                {{ __('Update account information, status, roles, and custom permissions') }}
            </p>
        </div>
                    ...
                    @can('users.delete')
                        @if(!$user->hasRole('System Owner') && $user->id !== auth()->id())
                            <button
                                ...
                                class="rounded-md border border-danger bg-white px-4 py-2 text-sm font-medium text-danger hover:bg-danger-surface"
                            >
                                {{ __('Delete') }}
                            </button>
                        @endif
