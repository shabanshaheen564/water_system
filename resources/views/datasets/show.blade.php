    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                ...
                @endcan
                <a href="{{ route('gis.index') }}?dataset={{ $dataset->id }}" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    {{ __('View on Map') }}
                </a>
            </div>
        </div>
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('gis.index') }}?dataset={{ $dataset->id }}" class="px-3 py-1 text-sm text-white bg-blue-600 rounded-md hover:bg-blue-700">
                    {{ __('View on Map') }}
                </a>
            </div>
