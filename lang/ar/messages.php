...
return [
    ...
    'roles' => [
        'System Owner' => 'مالك النظام', 'Admin' => 'مدير النظام', 'GIS Admin' => 'مهندس نظم المعلومات الجغرافية', 'Engineer' => 'مدير دائرة المياه', 'Field Worker' => 'مسؤول دائرة المياه', 'Viewer' => 'قلم الجمهور',
    ],
    'permission_groups' => [
        'users' => 'المستخدمون', 'roles' => 'الأدوار', 'permissions' => 'الصلاحيات', 'complaints' => 'الشكاوى', 'tasks' => 'المهام', 'gis' => 'نظم المعلومات الجغرافية', 'assets' => 'الأصول', 'reports' => 'التقارير', 'audit_logs' => 'سجل التدقيق', 'datasets' => 'البيانات الجغرافية',
    ],
    'permissions' => [
        ...
        'tasks.view' => 'عرض المهام', 'tasks.create' => 'إنشاء المهام', 'tasks.update' => 'تعديل بيانات المهام', 'tasks.delete' => 'حذف المهام', 'tasks.assign' => 'إسناد المهام', 'tasks.transition' => 'تغيير حالة المهام', 'tasks.update_status' => 'تحديث حالة المهام', 'tasks.view_updates' => 'عرض تحديثات المهام', 'tasks.create_update' => 'إضافة تحديثات المهام',
        ...
        'datasets.view' => 'عرض البيانات الجغرافية', 'datasets.create' => 'إنشاء البيانات الجغرافية', 'datasets.update' => 'تعديل البيانات الجغرافية', 'datasets.delete' => 'حذف البيانات الجغرافية',
    ],
    'user_management' => [
    ...
    'controllers' => [
        'dataset' => ['protected_configuration' => 'لا يمكن تغيير إعدادات البيانات الجغرافية بعد وجود سجلات أو معالم أو علاقات مرتبطة بها.'],
    ],
    'public' => [
    ...
    'navigation' => [
        'dashboard' => 'لوحة التحكم', 'datasets' => 'البيانات الجغرافية', 'create_dataset' => 'إضافة بيانات جغرافية', 'map' => 'الخريطة الجغرافية', 'users' => 'المستخدمون', 'roles' => 'الأدوار', 'permissions' => 'الصلاحيات', 'logout' => 'تسجيل الخروج',
    ],
    'ui' => [
        'close_menu' => 'إغلاق القائمة', 'open_menu' => 'فتح القائمة', 'main_navigation' => 'التنقل الرئيسي', 'sidebar' => 'القائمة الجانبية',
    ],
    'map' => [
        'layer_load_failed' => 'تعذر تحميل الطبقة', 'feature_details' => 'تفاصيل المعلم',
    ],
];
