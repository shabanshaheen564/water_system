...
return [
    ...
    'roles' => [
        ...
        'Admin' => 'مدير النظام',
        'GIS Admin' => 'مهندس نظم المعلومات الجغرافية',
        'Engineer' => 'مدير دائرة المياه',
        'Field Worker' => 'مسؤول دائرة المياه',
        'Viewer' => 'قلم الجمهور',
    ],
    'permission_groups' => [
    ...
    'permissions' => [
        ...
        'assets.view' => 'عرض الأصول', 'assets.create' => 'إنشاء الأصول', 'assets.update' => 'تعديل الأصول', 'assets.delete' => 'حذف الأصول',
        'reports.view' => 'عرض التقارير', 'reports.export' => 'تصدير التقارير', 'audit_logs.view' => 'عرض سجل التدقيق',
    ...
    'controllers' => [
        'dataset' => ['protected_configuration' => 'لا يمكن تغيير إعدادات مجموعة البيانات بعد وجود سجلات أو معالم أو علاقات مرتبطة بها.'],
    ],
    'public' => [
